"""Train a DeBERTa-v3 baseline for CoNLL-2003 Named Entity Recognition."""
...
class TrainingConfig:
    ...
    output_dir: Path = Path("models/deberta_ner")

    logging_dir: Path = Path("logs/deberta_ner")
...
def parse_args() -> TrainingConfig:
    ...
    parser = argparse.ArgumentParser(
        description="Train DeBERTa-v3 on CoNLL2003 NER."
    )
    ...
    parser.add_argument(
        "--output-dir",
        default="models/deberta_ner"
    )

    parser.add_argument(
        "--logging-dir",
        default="logs/deberta_ner"
    )
